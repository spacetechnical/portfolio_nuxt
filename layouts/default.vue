<template>
  <section>
    ...
    <header
      id="mobile"
      class="fixed p-10 h-screen bg-white top-0 z-50 -translate-x-80 transition-transform duration-300"
    >
      <nav>
        <ul class="flex flex-col gap-2">
          ...
          <a
            class="mb-2 text-xl hover:text-blue transition cursor-pointer"
            @click="activateBtn"
            href="#home"
          >
            Home
          ...
          <a
            class="mb-2 text-xl hover:text-blue transition"
            @click="activateBtn"
            href="#about"
            >About</a
          >
          ...
          >
          <a
            class="text-xl hover:text-blue transition"
            @click="activateBtn"
            href="#contact"
            >Contact</a
          >
    ...
    <header
      class="px-24 py-10 sticky bg-white z-50 h-auto"
      ...
      <nav>
        <ul class="flex justify-between items-center">
          ...
          <li class="hidden lg:block">
            <a
              class="text-xl hover:text-blue transition cursor-pointer"
              href="#home"
            >
              Home
            </a>
            <a
              class="text-xl ml-8 hover:text-blue transition cursor-pointer"
              href="#about"
              >About</a
            >
            <a
      ...
      <div class="w-9/12 m-auto">
        ...
        >
          <div class="w-full sm:w-1/3">
            <h1 class="text-xl mb-5">Muhammetaly Yuzbashyev</h1>
            <p>
          ...
          <div>
            <h1 class="text-xl mb-5">Social</h1>
            <div class="flex gap-3">
              <nuxt-link to="https://github.com/spacetechnical" target="_blank">
                <svg
                  width="23px"
                  height="23px"
                  viewBox="0 0 24 24"
              ...
              <nuxt-link to="https://t.me/mega_master7700" target="_blank">
                <svg
                  width="23px"
                  height="23px"
                  viewBox="0 0 24 24"
        ...
        <p class="text-center text-xs my-5">
          © Copyright <span>2023</span>. Made by Muhammetaly Yuzbashyev
        </p>
      </div>
    </footer>
  </section>
...
export default {
  ...
  methods: {
    activateBtn() {
      const mobile = document.getElementById("mobile").classList;
      this.isActive = !this.isActive;
      this.isActive
        ? mobile.remove("-translate-x-80") && mobile.add("-translate-x-0")
        : mobile.add("-translate-x-80") && mobile.remove("-translate-x-0");
    },
  },
};
</script>
